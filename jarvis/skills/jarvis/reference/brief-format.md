<!--
jarvis OUTPUT SPEC — render a brief in this shape from the Item data + the wiki.
This is a spec + worked example to imitate, NOT a templating engine.

The bar: a good chief-of-staff, not a notification dump.
...
- Track response debt: owed replies, oldest first, with aging.
...
- Always show the filtered count + how to correct it (this feeds jarvis-tune).

<!--
jarvis-tune OUTPUT SPEC — the weekly "what I learned about you" changelog + proposal.
...
- Skimmable, short lines, no wide tables. Delivered to brief_destination; nothing is applied
  unattended unless profile.automation.memory_writes permits (and never hard mutes/VIPs).
